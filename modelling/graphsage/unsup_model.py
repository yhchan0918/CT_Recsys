...
class Unsupervised_Model(torch.nn.Module):
...
def load_unsup_model(path, hidden_channels, data):
    model = Unsupervised_Model(hidden_channels=hidden_channels, data=data).to("cpu")
